...
[source, role='no_copy']
----
Server defaultServer package complete in ~/[path-to-repo]/paketo-buildpacks-intro/start/inventory/target\liberty\wlp\usr\servers\defaultServer\defaultServer.zip.
----
