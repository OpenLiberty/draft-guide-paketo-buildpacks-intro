...
This strucutre is typcially expected if you are familiar with building Open Liberty images. Although, when using `Paketo Buildpacks`, the image takes a much different structure. The `Paketo Buildpacks` structure is as follows:
