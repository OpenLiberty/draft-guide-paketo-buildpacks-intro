...
Learn how to build your microservices with Paketo Buildpacks and Open Liberty then run them in a container manager.
...
With `Paketo Buildpacks`, you are able to compile and create your microservice image with a single command and no other provided information. When you use the `Pack CLI` with the `Paketo Buildpacks` the `pack build` command will inspect, analyze and constuct your Open Liberty microservice into an Open Containers Initiative (OCI) images.
...
[.tab_content.docker_section]
--
You can test your microservice manually by hitting the endpoints or with automated tests that check your running Docker container.
--

[.tab_content.podman_section]
--
You can test your microservice manually by hitting the endpoint or with automated test that check your running `Podman` container.
--
